...
<template>
  ...
  <header class="sticky top-0 z-50 bg-surface/82 backdrop-blur-[12px] border-b border-border">
    <div class="max-w-[1280px] mx-auto flex items-center justify-between px-7 py-3.5">
      <a
        href="#home"
        class="flex items-center gap-[11px] text-text"
      >
        <svg width="34" height="34" viewBox="0 0 120 120" fill="none" aria-label="Angga logo">
          <defs>
        ...
        <span class="font-mono font-bold text-[14px] tracking-[.12em]">ANGGA DK</span>
      </a>
      <nav class="flex items-center gap-[26px]">
        <a
